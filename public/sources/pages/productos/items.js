...
function addItemCard(item) {
	const itemHTML = `
            <!-- <div class="card" style="width: 20rem; margin-bottom: 20px;">
                <img src="${
					item.imageUrl
				}" class="card-img-top" style="height: 250px; object-fit: cover;" alt="image">
                <div class="card-body">
                    <h5 class="card-title">${item.name}</h5>
                    <p class="card-text">${item.description}</p>
                </div>
            ...
            <div class="col-10 col-md-3 p-1">
                <div class="card" >                  
                        <img src="${
							item.imageUrl
						}" class="card-img-top product-img img-thumbnail">
                    <div class="card-body">
                        ...
                        <p class="card-text" id="texto-precio"><strong>Precio: $${
							item.price
						}</strong></p>
                    </div>
                    <div class="card-footer">
                    <button class="btn btn-primary" id="texto-boton"> Agregar a la canasta</button>
                    <button class="btn btn-primary mt-1" id="deleteBtn">Eliminar</button>
                    <button class="btn btn-primary mt-1" id="deleteBtn">Modificar</button>
                    </div>
                </div>
            </div>
        `;
